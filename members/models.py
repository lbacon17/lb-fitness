...
class Member(models.Model):
    ...
    subscription_package = models.ForeignKey(Package,
                                             on_delete=models.SET_NULL,
                                             null=True, blank=True,
                                             related_name='package')
    default_email_address = models.CharField(max_length=254, null=True,
                                             blank=True)
    ...
    default_town_or_city = models.CharField(max_length=50, null=True,
                                            blank=True)
    default_county_or_region = models.CharField(max_length=50, null=True,
                                                blank=True)
