...
* As a user, I want to subscribe to a training and nutrition plan to get me in shape and make me feel healthier
...
* As a user, I want to be able to change or cancel my subscription
...
* As a user, I want to be able to see my search results
* As a user, I want to be able to see the number of results
...
* As a user, I want to search the site for FAQs and read their answers
* As a user, I want to be able to read about a product’s individual details
* As a user, I have a question and want to see if it’s been asked already
